        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <p class="text-muted text-center">Faculty,Lu</p>

              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Phone</b> <a class="pull-right">{{$supervisor->phone}}</a>
                </li>
                <li class="list-group-item">
                  <b>Email</b> <a class="pull-right">{{$supervisor->email}}</a>
                </li>
                <li class="list-group-item">
                  <b>Department</b> <a class="pull-right">CSE</a>
                </li>
              </ul>

             

              <a href="tel: {{$supervisor->phone}} " class="btn btn-primary btn-block"><b>CALL</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p class="text-muted">
                B.S. in Computer Science from the University of Dhaka
              </p>
              ...
              <p class="text-muted">Sylhet, Bangladesh</p>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#settings" data-toggle="tab">Mail</a></li>
            </ul>
                ...
                <ul class="timeline timeline-inverse">
                  ...
                  <li>
                    ...
                    <div class="timeline-item">
                      <span class="time"><i class="fa fa-clock-o"></i><?php echo   date("h:i:sa") ?></span>

                      <h3 class="timeline-header"><a href="#">Blog</a></h3>
                  ...
                  <li>
                    ...
                    <h3 class="timeline-header"><a href="#">{{$supervisor->name}}</a> uploaded new photos</h3>
              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" id="inputComment" placeholder="inputComment"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
