...
<table class="table table-bordered" width="100%" cellspacing="0">
        ...
        @foreach($view_prevprojects as $view_prevproject)
        <tbody id="search_list">
           <tr>
                <td>{{$view_prevproject->name}}</td>
                <td>{{$view_prevproject->project_title}}</td>
                <td>{{$view_prevproject->framework}}</td>
                <td>{{$view_prevproject->project_txt}}</td>
                <td>
                
                    {!! Form::open(['method'=>'DELETE','action'=>['AdminController@destroy_preproject',$view_prevproject->id]]) !!}
                            {{csrf_field()}}
